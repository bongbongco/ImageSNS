 ...
 */
public class FlickerPhotoInfoBean {
    public Photo photo;
    public Owner owner;
    public String description, dates, comments;
    public ArrayList<Tag> tags;

    public FlickerPhotoInfoBean(String json) {
        try {
            init(json);
    ...
    public String generatePhotoURL(String size) {
        return "https://farm"+this.photo.farm+".staticflickr.com/"+this.photo.server+"/"+this.photo.id+"_"+this.photo.secret+"_"+size+".jpg";
    }
